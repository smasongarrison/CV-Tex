...
Applied Data Science for Psychologists (279). {\footnotesize WFU (taught 1x/year; \textit{1} total times)}\hfill{2026--Present}\\
...
Data Science for Psychologists in \R (703). {\footnotesize WFU (taught 1x/year; \textit{5} total times)}\hfill{2021--Present}\\

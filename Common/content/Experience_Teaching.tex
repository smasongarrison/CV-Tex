...
{\large {\bf Instructor}\\}
Data Science for Psychologists in \R (703). Wake Forest University \hfill {\textit{Spring 2021\textsuperscript{*}}}\smallskip\\
Psychological Testing  (362). Wake Forest University \hfill {Spring 2020;\textsuperscript{*} \textit{Spring 2021\noteBns}}\smallskip\\%\hfill{ \textit{Spring 2021} \noteB }\smallskip\\

...
\item \meb, Hunter, M.D., Smith, K. R, \& Burt, S. A. (Accepted). Temporal Changes in the Heritability of Longevity over the last 300 years: Preliminary Evidence from Extended Pedigrees with 176 Million Kinship pairs. Symposia talk to be presented at the Annual Meeting of the Behavior Genetics Association; Amsterdam, Netherlands
...
\begin{etaremune}
\item Hunter, M.D.,  \meb , Lyu, X.$\dagger$, Burt, S.A. (2026). New Questions for Designs as Old as Time: A Multilevel Random Intercepts Approach. Talk to be presented at the Annual Meeting of the Behavior Genetics Association; Amsterdam, Netherlands


\item Bogart, K., Krauter, M., Cipollina, R., Wang, K., Sykes, M., \meb, \& Harcourt, D. (Jun 2026) (Nov 2025) "It's harder to set boundaries when it's so obvious": Disclosing visible disabilities. Talk presented at the Appearance Matters Conference, Bristol, United Kingdom. Also, presented at DARN Research Subgroup (Nov 2025), Zoom.
...
\item Fay, C.$\dagger$ \& \meb  (Accepted). Evaluating modeling approaches for estimating genetic and environmental influences on drug initiation. Poster to be presented at the Annual Meeting of the Behavior Genetics Association; Amsterdam, Netherlands.  Also presented at the First-Year Graduate Student Poster Session, Department of Psychology, WFU.

\item Moyakhe, L.B., \meb,  Hunter, M.D., Lyu, X.$\dagger$, Mylakumar, N. M., Burt, S. A. (Jun 2026) Mitochondrial Inheritance Reveals Domain Specific Patterns of ASD Comorbidity. Poster to be presented to the Annual Meeting of the Behavior Genetics Association; Amsterdam, Netherlands

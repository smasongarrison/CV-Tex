...
\item \emsims, \jt, \& \meb (revise and resubmit). Exploring the relationship between depression and delinquency: A sibling comparison design using the NLSY.  \textit{Frontiers in Psychology} %\textit{Behavior Genetics}

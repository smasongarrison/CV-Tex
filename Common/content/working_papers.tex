...
\vspace{-2mm}\begin{center}\footnotesize{$\ddagger$ Joint first author$\ddagger$}\end{center}
\vspace{-2mm}\begin{center}\footnotesize{\textbabygamma Joint 2nd author\textbabygamma}\end{center} \vspace{-3mm}
...
\item Meese, W.,\footnotesize{$\ddagger$} Rubin-McGregor, J.\footnotesize{$\ddagger$}, Anderson, K.,\footnotesize{\textbabygamma} Bogart, K.,\footnotesize{\textbabygamma} Boring, B.,\footnotesize{\textbabygamma} \meb,\footnotesize{\textbabygamma} McManus, J.,\footnotesize{\textbabygamma} Moura, I., Van Doren, S.,\footnotesize{\textbabygamma} Benson, T., Cuenco, Z., Pearlstein, J., Plackowski, E., Klest, B., Rule, P., VanDaalen, R., Wang, K., Wu, F., \& Zisk, A. (submitted) Disability Representation in Social and Personality Psychology Research: A State of the Field Review. \textit{Social Psychological and Personality Science}.
...
\item Navarre, K. M.\noteB, Uliaszek, A., Masland, S. \& \meb. (in revision) Stigma by Design? The Role of Psychology Curriculum in Perpetuating and Preventing Borderline Personality Disorder Stigma. %\textit{Personality and Mental Health}%\textit{Teaching of Psychology}

...
\item Lyu, X$\dagger$, Burt, S. Alexandra, Hunter, Michael D., Good, Rachel,$\dagger$ Carroll, Sarah L., \& \meb. (Under review) Detecting mtDNA Effects with an Extended Pedigree Model: An Analysis of Statistical Power and Estimation Bias. %\href{https://link-to-your-paper-if-available}{\small\color{blue}{link-to-your-paper-if-available}} 

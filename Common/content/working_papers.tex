...
\item Lyu, Xuanyu$\dagger$ \&  \meb (Revise and Resubmit), Effects of Genetic Relatedness of Kin Pairs on Univariate ACE Model Performance. Target: \textit{Twin Research and Human Genetics}
...
%Invited
\item \meb, Webster, E.\noteA , and  Good, R.\noteA (Invited Submission) Diversifying the Behavior Genetic Pipeline: Pathways and Strategies for Incorporating Undergraduate Students. \textit{Behavior Genetics} IDEA special issue.

\item \meb, and Good, R.\noteA (Invited Submission) Foundations of genetically informed research, with a focus on sibling comparisons and family-based modeling. \textit{Pathways to Research}.

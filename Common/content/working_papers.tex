...
\vspace{-2mm}\begin{center}\footnotesize{$\star$ Joint first author$\star$}\end{center}
...
\item Meese, W.,\footnotesize{$\star$} Rubin-McGregor, J.\footnotesize{$\star$}, Anderson, K.,\footnotesize{$\babygamma$} Bogart, K.,\footnotesize{$\babygamma$} Boring, B.,\footnotesize{$\babygamma$} \meb,\footnotesize{$\babygamma$} McManus, J.,\footnotesize{$\babygamma$} Moura, I., Van Doren, S.,\footnotesize{$\babygamma$} Benson, T., Cuenco, Z., Pearlstein, J., Plackowski, E., Klest, B., Rule, P., VanDaalen, R., Wang, K., Wu, F., \& Zisk, A. (submitted) Disability Representation in Social and Personality Psychology Research: A State of the Field Review. \textit{Social Psychological and Personality Science}.

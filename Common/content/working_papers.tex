...
\begin{etaremune}
\item \meb \&  Moyakhe, L. B. (submitted) A Computational Challenge for Whole Trait Theory: From Traits to Neurodiverse Agents. Commentary Article for \textit{European Journal of Personality} on Fleeson \& Jayawickreme (2026) Getting from states to traits: Whole Trait Theory's explanatory and developmental engine
\item O’Connor, S. M., Burt, S. A., \meb \& Klump, K. L. (Revision Under Review) The contribution of genetic and environmental influences underlying disordered eating to exposure to weight-conscious peers. \textit{Psychological Medicine}

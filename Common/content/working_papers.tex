...
\item \emsims, \jt, \& \meb (Under review). Exploring the relationship between depression and delinquency: A sibling comparison design using the NLSY.  \textit{Frontiers in Psychology} %\textit{Behavior Genetics}

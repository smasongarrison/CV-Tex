...
\begin{etaremune}%
\item Hwang, Yoo Ri$\dagger$ (\textit{Jul 2022}), \textit{A Comparison of Regression-Based and Multilevel Approaches in Dyadic Analysis with a Categorical Explanatory Predictor } Wake Forest%

...
\begin{etaremune}%
\item Lyu, Xuanyu $\dagger$ (Spring 2023), \textit{TBD}.  Wake Forest% mine's
\item Lacey, Connor (Spring 2023), \textit{TBD}.  Wake Forest% v's
...
\item Lacey, Connor (Oct 2022), \textit{Effect Sizes for Measurement Non-Invariance: A Review}.  Wake Forest% v's

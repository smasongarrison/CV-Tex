...
\item Good, Rachel  (2023-2024), Intergenerational Transmission of Suicide in the UPDB%.  Wake Forest
%\item Zhang, Qilin  (Spring 2023)
\item Lyu, Xuanyu  (2021-2023), Pedigree Structures Impact Statistical Power of MtDNA Effects Estimation%.  Wake Forest
\item Hwang, Yoo Ri (2020-2022) A Comparison of Regression-Based and Multilevel Approaches in Dyadic Analysis with a Categorical Explanatory Predictor%. Wake Forest%
\end{etaremune}%\\
%\pagebreak
\begin{comment}
{\large \textbf{Member}}\\%
...
\item Lacey, Conor (Jul 2023), \textit{Bayesian Approaches to Quantifying the Practical Impact of Measurement Non-invariance: Extending $d_{MACS}$}.  Wake Forest% v's
...
\vspace{-1mm}\begin{center}\footnotesize{denotes mentored $\dagger$graduate$\dagger$ student advisee}\end{center}\vspace{-2mm}
\begin{etaremune}%
\item  Good, Rachel $\dagger$ (\textit{Oct 2023}), \textit{Intergenerational Transmission of Suicide}  Wake Forest% m's
...
\begin{etaremune}%
\item Virk, Anahatt (2025-2026), \textit{Health, Exercise, and Fertility: A Family-Based Exploration of How Health and Exercise Influence Reproductive Outcomes}
\item Tyson, Holland (2024-2025), \textit{Examining the Interplay of ADHD and Sexual Activity: A Sibling Comparison Approach}

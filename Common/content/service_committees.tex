...
\begin{etaremune}%
\item Good, Rachel  (\textit{Summer 2023-2024})
...
\begin{etaremune}%
\item Lacey, Conor (\textit{Jul 2023}), \textit{Bayesian Approaches to Quantifying the Practical Impact of Measurement Non-invariance: Extending $d_{MACS}$}.  Wake Forest% v's
